...
manifest={'appId':'com.muzermat.harnessremote','version':version,'versionCode':code,'minimumAndroid':10,'minimumSdk':29,'targetSdk':36,'protocolVersion':1,'appTransportVersion':1,'compatiblePlugin':'>=0.2.0 <0.3.0','androidSource':{'repository':'https://github.com/y38501148-max/harness-remote-android','commit':android_commit},'pluginSource':{'repository':'https://github.com/y38501148-max/dsh-mobile-remote','commit':plugin_commit},'apk':{'filename':name,'sha256':sha(dest),'signingCertificateSha256':certificate},'network':'direct-ipv6-pinned-tls','distribution':'preview'}
